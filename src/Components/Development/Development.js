...
export default function Development() {
  ...
  return (
    <>
      {form && (<>
        <p className={CSS.main}>الرئيسية/الدورات التطويرية</p>
        ...
        <div className={CSS.inputs}>
          ...
          <div className={CSS.details}>
            <input type="number" defaultValue={course.hours} placeholder="عدد ساعات الدورة" onChange={(e) => { setCourse({ ...course, hours: e.target.value }) }} />
        ...
        <div ref={placeContainer} className={CSS.placeContainer}>
          ...
          {places2.filter(value => {
            ...
            <div key={city} className={CSS.placeDiv}>
              <div className={CSS.imgDiv}>
                <img src={places[places2.indexOf(city)].img} style={{ width: "100px" }} alt="img" />
                <div className={CSS.cityDiv}>
